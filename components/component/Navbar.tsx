  ...
  return (
    <div className='flex fixed top-0 left-0 w-full p-2 border-b border-gray-400 items-center justify-between bg-white'>
      ...
      <div className='login flex items-center gap-4'>
        <button className='bg-black text-white px-4 py-2 rounded-lg hover:bg-gray-700  font-medium'>SIGN UP</button>
        <button className='bg-black text-white px-4 py-2 rounded-lg hover:bg-gray-700 font-medium'>SIGN IN</button>
        <button className='text-black px-4 py-2 rounded-lg hover:text-white font-bold hover:bg-red-600 border-2 border-grey'>CONNECT WALLET</button>
      </div>
    </div>
  );
};
