        ...
        <div className="max-w-3xl mx-auto space-y-8">
          <div>
            ...
            <p className="mt-10 text-lg sm:text-2xl md:text-2xl">
              At VielX, we empower users to take control of their data. We
              prioritize privacy by allowing users to redact sensitive
              information from their documents, ensuring their security.
            </p>
            <p className="mt-6 text-lg sm:text-2xl md:text-3xl">
              We also provide a unique opportunity for users to share
              non-sensitive data with trusted companies in exchange for rewards.
              This approach balances privacy with the potential to benefit from
              data sharing.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-10 text-xl sm:text-2xl md:text-3xl">
              We are committed to continually innovating and improving our
              platform to provide the best experience for our users. We actively
              seek feedback and make updates to enhance security, usability, and
              user satisfaction.
            </p>
          </div>
        </div>
